...
PATIENTS = [
    ...
    # 가족 데이터 (보호자 키워드 포함)
    (10001, 'F-0003', '12340001', '보호자 김가나', 'M65.03', '2024-03-16', ''),
    # 같은 병록번호에 P/F 공존 → P가 대표
